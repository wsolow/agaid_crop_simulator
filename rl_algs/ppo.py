...
class Args:
    ...
    wandb_project_name: str = "ppo_npk_fert_limited"
...
def make_env(env_id, kwargs, idx, capture_video, run_name):
    def thunk():
...
def main(args):
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.env_id, args.npk, i, args.capture_video, run_name) for i in range(args.num_envs)],
    )
